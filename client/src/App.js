    ...
    const sendFile = async () => {
        ...
        if (image) {
            ...
            try {
                ...
                toast.error("Terjadi kesalahan sistem saat memeriksa gambar.");
                setData(null);
            }
        }
    };
                ...
                {!data ? (
                    ...
                    >
                        ...
                        >
                            ...
                            <Box sx={{ mb: 1 }} color={'#1B4332'}>🌿 Pilih Jenis Tanaman Yang Sesuai</Box>
                            <Box sx={{ mb: 1 }} color={'#1B4332'}>🪴 Unggah Gambar</Box>
                            <Box sx={{ mb: 1 }} color={'#1B4332'}>🔍 Klik Periksa</Box>
                            <Box sx={{ mb: 1 }} color={'#1B4332'}>📋 Lihat Hasil Analisis</Box>
                            <Box color={'#1B4332'}>🔄 Hapus Gambar</Box>
                        </Card>
                        ...
                        >
                            ...
                            <SelectBox plant={plant} setPlant={setPlant} />
                            ...
                            <Box sx={{ mt: 3 }}>
                                {!image && (
                                    ...
                                    >
                                        <input {...getInputProps()} />
                                        <Typography>Tarik & lepas gambar di sini</Typography>
